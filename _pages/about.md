...
<figure class="content-figure">
  ...
  <figcaption>Illustrative examples. (Top row) exposed fault plane with slick and slides in Oregon, Dune du Pilat in France. (Bottom row) Folded and overturned flysch in Zumaia Spain, lahar (debris flow) deposit at Mt. Lassen California. Photos by author.</figcaption>
</figure>
